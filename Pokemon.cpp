...
public:
    ...
    void greetPlayer(Player& player) {
        ...
        cout << "Professor Oak: But enough about me. Let us talk about you!\n";
        cout << "Professor Oak: First, tell me, what is your name?\n\n[";
        cin >> player.name;
    ...
    void explainMainQuest(Player& player) {
        cout << "Professor Oak: Ah, " << player.name << ", let me tell you about your grand adventure that is about to unfold!\n";
        waitForEnter();
